...
export const tutorials: Record<TutorialPage, TutorialDefinition> = {
  ...
  intake: {
    ...
    steps: [
      { title: 'أجب على السؤال الحالي', body: 'اكتب الإجابة في الحقل أدناه أو اختر من الخيارات المعروضة.' },
      { title: 'تابع من النموذج', body: 'استخدم زر التالي داخل النموذج للانتقال؛ أزرار الدليل هنا للشرح فقط.' },
      { title: 'افتح الحالة للفريق', body: 'بعد ظهور النتيجة يمكن فتح ملف الحالة في لوحة الإدارة.' },
    ],
  },
  admin: {
    page: 'admin',
